...
public class UserAccountsRequestProcessWindowBuilderImpl extends AbstractWindowContainerManagedWindowBuilderProcessDataImpl implements UserAccountsRequestProcessWindowBuilder, Serializable {
	...
	protected void __execute__(Form form, Data data,SystemAction systemAction, ViewBuilder viewBuilder) {
		...
		GridBuilder gridBuilder = __inject__(GridBuilder.class).setRowClass(PersonReadRow.class).setRowDataClass(Person.class)
				...
				.addObjects( (Collection)((UserAccountsRequest)data).getPersons().get() )
				;
