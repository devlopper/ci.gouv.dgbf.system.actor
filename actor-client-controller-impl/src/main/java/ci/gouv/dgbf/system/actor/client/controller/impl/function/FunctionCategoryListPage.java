...
import ci.gouv.dgbf.system.actor.client.controller.entities.function.FunctionCategoryListWindowBuilder;
...
public class FunctionCategoryListPage extends AbstractPageContainerManagedImpl implements Serializable {
	...
	protected WindowBuilder __getWindowBuilder__() {
		return __inject__(FunctionCategoryListWindowBuilder.class).execute().getOutput();
	}
